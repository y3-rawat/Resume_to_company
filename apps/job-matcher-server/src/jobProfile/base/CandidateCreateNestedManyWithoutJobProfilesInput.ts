...
@InputType()
class CandidateCreateNestedManyWithoutJobProfilesInput {
...
export { CandidateCreateNestedManyWithoutJobProfilesInput as CandidateCreateNestedManyWithoutJobProfilesInput };
